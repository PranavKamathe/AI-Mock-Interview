  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        interviewQuestions = JSON.parse(fullText);

        cleanedText = JSON.stringify(interviewQuestions);
        ...
        console.error(
          "❌ Error parsing interview questions JSON:",
          parseError
        );
        ...
        <form onSubmit={onSubmit}>
          <div>
            <h2 className="font-medium">
              Add details about Job Position, Your Skill & Year of Experience
            </h2>
